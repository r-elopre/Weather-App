...
class DavaoWeatherViewModel : ViewModel() {
    ...
    private val database = FirebaseDatabase.getInstance().getReference("davao_comments")
    ...
    private fun getWeatherData() {
        viewModelScope.launch {
            try {
                ...
                Log.d("WeatherResponse", "Davao: $response")
            } catch (e: Exception) {
                e.printStackTrace()
                Log.e("WeatherResponseError", "Failed to fetch weather data for Davao", e)
            }
        }
    }
